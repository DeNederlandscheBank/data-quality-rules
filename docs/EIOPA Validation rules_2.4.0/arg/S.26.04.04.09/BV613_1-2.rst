...
BV613_1-2: if ({{S.26.04.04.09, r0030,c0010}} = [s2c_AP:x34]) then {{S.26.04.04.01, r0330,c0060}} = max(0, ({{S.26.04.04.01, r0330,c0020}} - {{S.26.04.04.01, r0330,c0030}}) - ({{S.26.04.04.01, r0330,c0040}} - {{S.26.04.04.01, r0330,c0050}}))
...
S.26.04.04.01,r0330,c0060 [decrease of medical payments, net solvency capital requirement]
