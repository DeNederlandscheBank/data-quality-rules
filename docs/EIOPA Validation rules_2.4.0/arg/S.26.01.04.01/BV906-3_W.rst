...
BV906-3_W: if ({{S.01.01.04.01,r0500,c0010}}=[s2c_CN:x1] and not(empty({{S.26.01.04.01,r0440,c0020}}))) then not(empty({{S.26.01.04.01,r0430,c0020}})) where ExDimVal({{S.26.01.04.01,r0430,c0020}},AO)=x0 and ExDimVal({{S.26.01.04.01,r0440,c0020}},AO)=x0
