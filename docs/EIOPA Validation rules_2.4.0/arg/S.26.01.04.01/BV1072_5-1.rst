...
BV1072_5-1: [ (c0050)] if (empty({{S.26.01.04.01, r0461}}) and empty({{S.26.01.04.01, r0462}}) and empty({{S.26.01.04.01, r0480}}) and empty({{S.26.01.04.01, r0481}}) and empty({{S.26.01.04.01, r0482}}) and empty({{S.26.01.04.01, r0483}})) then not(empty({{S.26.01.04.01, r0450}}))
