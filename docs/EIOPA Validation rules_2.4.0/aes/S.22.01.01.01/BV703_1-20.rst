...
BV703_1-20: if ({{S.01.02.01.01, r0200,c0010}} = [s2c_AP:x12] and {{S.01.02.01.01, r0190,c0010}} = [s2c_AP:x10] and {{S.01.02.01.01, r0180,c0010}} = [s2c_AP:x7] and {{S.01.02.01.01, r0170,c0010}} = [s2c_PU:x52]) then {{S.22.01.01.01, r0030,c0100}} = {{S.22.01.01.01, r0030,c0070}}
...
S.22.01.01.01,r0030,c0100 [Basic own funds|Excess of assets over liabilities , Impact of the LTG measures and transitionals (Step-by-step approach)|Impact of all LTG measures and transitionals]
