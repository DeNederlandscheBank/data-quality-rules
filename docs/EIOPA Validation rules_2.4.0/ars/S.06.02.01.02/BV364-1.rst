...
BV364-1: {{S.02.01.01.01,r0090,c0010}}=sum({{S.06.02.01.01,c0170,snnn}}) where matches({{S.06.02.01.02,c0290}},"^..((3)|(4)).$") and {{S.06.02.01.02,c0310}} != [s2c_PU:x16] and {{S.06.02.01.01,c0090}}=[s2c_LB:x91]
