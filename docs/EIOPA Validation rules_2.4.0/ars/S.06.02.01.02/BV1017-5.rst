...
BV1017-5: if (sum({{S.06.02.01.01,c0170,snnn}})gt (0.3 *({{S.02.01.01.01,r0070,c0010}}+{{S.02.01.01.01,r0220,c0010}}))) then {{S.01.01.01.01,r0150,c0010}} = [s2c_CN:x1] or {{S.01.01.01.01,r0150,c0010}} = [s2c_CN:x23] where matches({{S.06.02.01.02,c0290}},"^..4.$")
