...
BV636_1-1_W: if ({{S.26.05.01.05, r0010,c0010}} = [s2c_AP:x34]) then {{S.26.05.01.01, r0110,c0090}} = ({{S.26.05.01.01, r0110,c0060}} + {{S.26.05.01.01, r0110,c0070}}) * (0.75 + 0.25 * {{S.26.05.01.01, r0110,c0080}})
...
S.26.05.01.01,r0110,c0080 [Motor, other classes , Volume measure for premium and reserve risk|Geographical Diversification]
